...
quiz: false
---
<div className="content-chunk" data-subsection-id = "What-Is-a-Loop-61pt">
## What Is a Loop?
...
<div className="content-chunk" data-subsection-id = "Traditional-For-Loops-in-Python-385t">
...
<Notebook code = {`i = 1`}/>  
<Notebook code = {`while i > 0:`}/>  
<Notebook code = {`    print(i)`}/>
...
<Notebook code = {`#Figure 3.3.12\nimport random\nnumGames = 2\nprint("How many games would you like to play?", numGames)\nj = 0\n#Repeats this the number of games the user chose \nfor i in range(0, numGames):\n\trandom.seed(i)\n\tprint("Game start!")\n\t#Get a random number from 1 to 100\n\thiddenNumber = random.randint(1, 100)\n\t#Create userGuess and give is a value that can't be correct\n\tuserGuessList = [0, 60, 33, 50, 60, 45, 20, 18]\n\t#Repeat until the guess is correct \n\twhile not userGuessList[j] == hiddenNumber:\n\t\tj+=1\n\t\t#Get the user's next guess as an integer\n\t\tuserGuess = userGuessList[j]\n\t\tprint("Guess a number:", userGuess)\n\t\t#Check if the guess is too high \n\t\tif userGuess > hiddenNumber:\n\t\t\tprint("Too high!")\n\t\t#Check if the guess is too low \n\t\telif userGuess < hiddenNumber:\n\t\t\tprint("Too low!")\n\t\t#The guess must be right! \n\t\telse:\n\t\t\tprint("That's right!")`}/>
...
<Notebook code = {`#Figure 3.3.13\nimport random\ni, j=0, 0\nkeepPlayingList = ["y", "y", "y", "n"]\n#While keepPlaying is "y"\nwhile keepPlayingList[i] == "y":\n\ti+=1\n\tkeepPlaying = keepPlayingList[i]\n\trandom.seed(i)\n\tprint("Game start!")\n\t#Get a random number from 1 to 100\n\thiddenNumber = random.randint(1, 100)\n\t#Create userGuess and give is a value that can't be correct\n\tuserGuessList = [0, 7, 40, 18, 30, 30, 8, 40, 31]\n\t#Repeat until the guess is correct \n\twhile not userGuessList[j] == hiddenNumber:\n\t\tj+=1\n\t\t#Get the user's next guess as an integer\n\t\tuserGuess = userGuessList[j]\n\t\tprint("Guess a number: ", userGuess)\n\t\t#Check if the guess is too high \n\t\tif userGuess > hiddenNumber:\n\t\t\tprint("Too high!")\n\t\t#Check if the guess is too low \n\t\telif userGuess < hiddenNumber:\n\t\t\tprint("Too low!")\n\t\t#The guess must be right! \n\t\telse:\n\t\t\tprint("That's right!")\n\t#Update keepPlaying\n\tprint("Play again (y for yes, n for no)? ", keepPlaying)`}/> 
...
<Notebook code = {`#Figure 3.3.16\nnumCount = 5\n#Get the number of numbers to average\nprint("How many numbers will you average?", numCount)\nnextNumberList = [0, 91, 92, 93, 94, 95]\n#Loop numCount times\nfor i in range(1, numCount + 1):\n\t#Creates sum with the value\n\tsum = 0\n\t#Gets the user's number\n\tnextNumber = nextNumberList[i]\n\tprint(f"Number #{i}: {nextNumber}")\n\t#Add the inputted number to the sum \n\tsum += nextNumber\n#Print the sum over numCount \nprint(sum / numCount)`}/>
