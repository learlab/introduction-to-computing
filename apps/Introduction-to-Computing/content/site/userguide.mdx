...
Complete the intake survey using this url ([https://peabody.az1.qualtrics.com/jfe/form/SV_by0Gux3sGmnUXJk](https://peabody.az1.qualtrics.com/jfe/form/SV_by0Gux3sGmnUXJk)) *BEFORE* you start using iTELL.

You are *also* required to complete an outtake survey *AFTER* you FINISH using iTELL using this url ([https://peabody.az1.qualtrics.com/jfe/form/SV_cSljIM0923euOcm](https://peabody.az1.qualtrics.com/jfe/form/SV_cSljIM0923euOcm)).

Again, note that these are *two different* surveys, one that must be completed before using the application, and one after.
